...
mixin _$DetailState {
 ...
 bool get isLoading; WallDetailEntity? get detail; String? get errorMessage;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is DetailState&&(identical(other.isLoading, isLoading) || other.isLoading == isLoading)&&(identical(other.detail, detail) || other.detail == detail)&&(identical(other.errorMessage, errorMessage) || other.errorMessage == errorMessage));
}
...
@override
String toString() {
  return 'DetailState(isLoading: $isLoading, detail: $detail, errorMessage: $errorMessage)';
}
...
@useResult
$Res call({
 bool isLoading, WallDetailEntity? detail, String? errorMessage
});
...
as WallDetailEntity?,errorMessage: freezed == errorMessage ? _self.errorMessage : errorMessage // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool isLoading,  WallDetailEntity? detail,  String? errorMessage)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _DetailState() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool isLoading,  WallDetailEntity? detail,  String? errorMessage)  $default,) {final _that = this;
switch (_that) {
case _DetailState():
return $default(_that.isLoading,_that.detail,_that.errorMessage);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool isLoading,  WallDetailEntity? detail,  String? errorMessage)?  $default,) {final _that = this;
switch (_that) {
case _DetailState() when $default != null:
return $default(_that.isLoading,_that.detail,_that.errorMessage);case _:
  return null;
...
class _DetailState extends DetailState {
  const _DetailState({this.isLoading = false, this.detail, this.errorMessage}): super._();
  

@override@JsonKey() final  bool isLoading;
@override final  WallDetailEntity? detail;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _DetailState&&(identical(other.isLoading, isLoading) || other.isLoading == isLoading)&&(identical(other.detail, detail) || other.detail == detail)&&(identical(other.errorMessage, errorMessage) || other.errorMessage == errorMessage));
}
